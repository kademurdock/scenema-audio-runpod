...
RUN git clone https://github.com/Tencent-Hunyuan/AuK /app/upstream && cd /app/upstream && git checkout e1c935e81e356c87419d9509d7f8a4091457bdca && pip install --no-cache-dir --no-build-isolation . "transformers==4.57.6" "huggingface-hub==0.36.2" "runpod>=1.7,<2" "boto3>=1.35,<2" "soundfile>=0.12,<1" "requests>=2.32,<3"
